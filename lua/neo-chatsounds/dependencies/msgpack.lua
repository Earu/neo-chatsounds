-- FROM: https://framagit.org/fperrad/lua-MessagePack/-/blob/master/src/MessagePack.lua
-- MODIFIED TO WORK IN GARRYS MOD AND LUA 5.1 EXCLUSIVELY
...
local loadstring = CompileString
