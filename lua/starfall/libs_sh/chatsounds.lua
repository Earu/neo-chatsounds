...
SF.Permissions.registerPrivilege("chatsounds.playOnPlayers", "Chatsounds Play methods", "Allow the user to emit chatsounds from you", { server = { default = 1 }, client = {} })
SF.Permissions.registerPrivilege("chatsounds.repos", "Chatsounds addRepo methods", "Allow the user to add new chatsounds repos", { client = { default = 1 } })
